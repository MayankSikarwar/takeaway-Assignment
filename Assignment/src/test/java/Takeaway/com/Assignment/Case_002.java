...
public class Case_002 extends base {
	...
	@Test()
	public void caseTwo_CreateOrderAndGetOrderReference() throws IOException {
		...
		Assert.assertEquals(true,
				utility.getRestaurant(ReadJsonData.customerDetails(testCaseNumber).get("restaurantName"))); // if the
																											// Requested
		// restaurant is
		...
		// false and test case
		// fails.
		Assert.assertEquals(true, utility.getMeal(ReadJsonData.customerDetails(testCaseNumber).get("mealName")));// if
																													// the
																													// Requested
																													// meal
																													// is
